...
<fmt:bundle basename="${locale}" prefix="registration.">
	...
	<fmt:message key="user.password_requirements"
...
<body>
	...
	<form name="customerRegister" action="${urlPrefix}/register/customer/add"
		...
		<fieldset>
			...
			<table class="registration">
				<tr>
					...
					<td><input id="login" name="login" type="text"
						pattern="^[\w]{8,}$" required /></td>
					<td></td>
				</tr>
				...
				<tr>
					<td><label for="passw1">${password}${colon}</label></td>
					<td><input id="passw1" name="password" type="password"
						required /></td>
					<td></td>
				</tr>
				<tr>
					<td><label for="passw2">${password_confirm}${colon}</label></td>
					<td><input id="passw2" name="password_confirm" type="password"
						required /></td>
					<td></td>
				</tr>
				...
				<tr>
					<td colspan="3"><br />
						...
						<p class="information">${password_requirements}</p></td>
				</tr>
			</table>
		</fieldset>
		<fieldset>
			...
			<table class="registration">
				<tr>
					<td><label for="company">${company_name}${colon}</label></td>
					<td><input id="company" name="company_name" type="text" /></td>
				</tr>
				<tr>
					<td colspan="2">
		...
		<fieldset>
			...
			<table class="registration">
				<tr>
					<td><label for="name">${user_name}${colon}</label></td>
					<td><input id="name" name="name" type="text"
						pattern="(^[a-zA-Z-]{3,}$)|(^[А-Яа-я-]{3,}$)" required /></td>
				</tr>
				<tr>
					<td><label for="surname">${user_surname}${colon}</label></td>
				...
				<tr>
					<td><label for="email">${email}${colon}</label></td>
