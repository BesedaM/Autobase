...
<body>
	...
	<form name="LoginForm" method="post" action="${urlPrefix}/controller">
		<input type="hidden" name="command" value="login" />

		<p>${prompt}</p>
		<table>
			<tr>
				<td class="login"><label for="login">${login}${colon}</label></td>
				<td><input id="login" name="login" type="text" required /></td>
			</tr>
			<tr>
				<td><label for="password">${password}${colon}</label></td>
	...
	<form name="CustomerRegisterRedirect" method="get"
