...
public class SQLQuery {
    ...
    static {
        ...
        CAR_ROUTE_UPDATE_DEPENDENCE = "INSERT INTO autobase.cars_in_routes (route_id, car_id) VALUES (?,?)";
        ...
        INSERT_TASK = "INSERT INTO autobase.tasks (time, details) VALUES (?, ?)";
        ...
        INSERT_ROUTE = "INSERT INTO autobase.routes (name, status_id,id) VALUES (?, ?, ?)";
        ...
        SELECT_CURRENT_REQUESTS_ID = "SELECT requests.id FROM autobase.requests RIGHT JOIN autobase.routes ON requests.id=routes.id  \n" +
                "LEFT JOIN autobase.request_status ON requests.status_id=request_status.id\n" +
                "LEFT JOIN autobase.route_status ON routes.status_id=route_status.id\n" +
